...
$('#license_up').change(function(){
	previewImage(this,'license_up','license_wrap','license_img');
	var formData = new FormData();
...
$('#confirmate_up').change(function(){
	previewImage(this,'confirmate_up','confirmate_wrap','confirmate_img');
	var formData = new FormData();
...
$('#submit').click(function(){
	var nickname = $('.zhidao_ipt').val(),
    	...
    	email = $('#Contact_mail').val(),
    	organizationname = $('#organization_ipt').val();
	if(nickname!=''&&introduce!=''&&zd_head!=''&&auxiliarymaterials!=''&&name!=''&&idnumber!=''&&IDcard!=''&&Selfie!=''&&email!=''&&organizationname!=''&&license!=''&&confirmate!=''&&!$('.tips').hasClass('show')){
		if(address=='1'){
